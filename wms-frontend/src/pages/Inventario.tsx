...
const statusMeta: Record<ContagemItem['status'], { l: string; tone: any }> = {
      ...
      >
        <button
          ...
          onClick={() =>
            toast({
              tipo: 'sucesso',
              titulo: 'Nova rodada gerada',
              texto: 'A demo criou novas contagens priorizando curva A e endereços críticos.',
            })
          }
        >
